...
x ≺ y ⇔ (s_x > s_y) ∨ (s_x = s_y ∧ d_x < d_y) ∨ (s_x = s_y ∧ d_x = d_y ∧ t_x < t_y),     (3.4)
...
*d*_*x*, *d*_*y* — відстань між місцями події для кандидатів *x*, *y*, км, обчислена за формулою (3.2);
*t*_*x*, *t*_*y* — різниця дат події для кандидатів *x*, *y*, діб, обчислена за формулою (3.3).
