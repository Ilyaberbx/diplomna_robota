...
|---|---|---|---|---|
| ТК-1 | Користувач не зареєстрований | Ввести унікальну пошту і пароль, підтвердити | Створено обліковий запис, видано токен | Відповідає очікуваному |
| ТК-2 | Пошта вже зареєстрована | Ввести зайняту пошту, підтвердити | Відмова «пошту зайнято», запис не створено | Відповідає очікуваному |
| ТК-3 | Обліковий запис існує | Ввести правильні пошту і пароль | Видано токен і дані користувача | Відповідає очікуваному |
| ТК-4 | Обліковий запис існує | Ввести правильну пошту і невірний пароль | Відмова «невірні дані» | Відповідає очікуваному |
| ТК-5 | Користувач автентифікований | Заповнити форму коректними даними, підтвердити | Оголошення збережено зі станом «активне» | Відповідає очікуваному |
| ТК-6 | Користувач автентифікований | Подати форму з порожніми обов'язковими полями | Відмова з повідомленням про помилку, запис не створено | Відповідає очікуваному |
| ТК-7 | Є активні оголошення | Відкрити стрічку, задати фільтри виду й періоду | Повернено відфільтровану сторінку без контактів | Відповідає очікуваному |
| ТК-8 | Користувач — автор оголошення | Відкрити власне оголошення, запросити кандидатів | Повернено ранжований перелік кандидатів | Відповідає очікуваному |
| ТК-9 | Користувач не є автором оголошення | Запросити кандидатів чужого оголошення | Відмову у доступі | Відповідає очікуваному |
| ТК-10 | Користувач — автор, переглядає кандидатів | Обрати кандидата, «Запропонувати зв'язок» | Зв'язок створено у стані «запропоновано» | Відповідає очікуваному |
| ТК-11 | Зв'язок запропоновано, актор — друга сторона | Відкрити зв'язок, підтвердити | Зв'язок «підтверджено», контакти взаємно розкрито | Відповідає очікуваному |
| ТК-12 | Зв'язок запропоновано, актор — ініціатор | Спробувати підтвердити власний зв'язок | Відмову у доступі | Відповідає очікуваному |
| ТК-13 | Оголошення про втрату без підтвердженого зв'язку | Перевести оголошення у стан «повернуто» | Відмова: неприпустимий перехід | Відповідає очікуваному |
| ТК-14 | Для пари оголошень уже існує зв'язок | Запропонувати ще один зв'язок для тієї самої пари | Відмова: конфлікт унікальності | Відповідає очікуваному |
