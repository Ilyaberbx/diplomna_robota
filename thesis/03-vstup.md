...
**Мета і задачі роботи.** Метою роботи є підвищення ефективності первинного зіставлення оголошень про загублених і знайдених домашніх тварин шляхом розроблення вебзастосунку, що автоматично формує ранжований перелік ймовірних збігів. Ефективність зіставлення оцінюється якістю ранжування (часткою випадків, коли істинний збіг потрапляє в перші позиції переліку, та середнім оберненим рангом істинного збігу) і часом формування переліку; досягнення мети підтверджується експериментально. Для досягнення поставленої мети необхідно вирішити такі задачі:
...
**Об'єкт роботи.** Об'єктом роботи є процес автоматизації зіставлення оголошень про загублених і знайдених домашніх тварин засобами вебзастосунку.
