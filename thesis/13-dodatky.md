ДОДАТОК А
Програмна реалізація схеми бази даних
...
ДОДАТОК Б
Програмна реалізація сервісу зіставлення оголошень
...
ДОДАТОК Г
Програмна реалізація сервісу підтвердження зв'язку
...
<!-- ОФОРМЛЕННЯ:
- Кожен додаток — з нової сторінки. «ДОДАТОК А» (Б, В, Г) — ВЕЛИКИМИ, напівжирний, по центру, без крапки; назва додатка з нового рядка, малими з першої великої, по центру, без абзацного відступу, без крапки.
- Літери додатків А, Б, В, Г — дозволені (заборонені: Ґ, Є, З, І, Ї, Й, О, Ч, Щ, Ь).
- Лістинги коду: Courier New 10 пт, одинарний інтервал, ліве вирівнювання, без абзацних відступів, з підсвічуванням синтаксису.
...
- Наскрізна нумерація сторінок охоплює додатки.
-->
