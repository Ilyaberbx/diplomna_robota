...
- [reports](../apps/client/src/modules/reports/MODULE.md) — create wizard (skippable photo step), URL-synced browse feed, report detail with projection switch + reporter-only candidates link, ranked candidates page, photo/placeholder rendering.
